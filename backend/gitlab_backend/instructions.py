"""Parse a GitLab issue body into structured fields for the ML pipeline."""
...
def parse(body: str) -> dict:
    ...
    Returns a dict with keys:
        task_type       — normalised string or None
        target_column   — string or None
        human_feedback  — assembled free-text for agents
    ...
    # Split on ## headings, preserving heading text as first line of each chunk
    ...
    for section in sections:
        ...
        if "task type" in heading:
            ...
            # Accept: `column_name`, column: name, or plain text
    ...
    # Assemble human_feedback from all structured sections
    parts: list[str] = []
